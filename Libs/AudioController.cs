...
using AudioSettings = Sons.Settings.AudioSettings;
...
public class AudioController
{
    ...
    public static void PlayBSound(SonsFMODEventEmitter emitter, string eventPath, SoundType type, float volumeAdjustmant = 1)
    {
        float volume = type == SoundType.Music ? AudioSettings._musicVolume * SoundManager.MusicLvl : AudioSettings._sfxVolume * SoundManager.SfxLvl;

        emitter.SetEventPath(eventPath);
